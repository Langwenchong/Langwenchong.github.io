    ...
    var sure = function () {
            ...
            botui.message.add({
                ...
                botui.message.add({
                    ...
                    botui.message.add({
                        ...
                        botui.message.add({
                            delay: 1500,
                            content: "热爱前端技术，对html,css,js和vue都有了解"
                        }).then(function () {
                            botui.message.add({
                                delay: 1500,
                                content: "同时热爱算法和数据管理，志在成为一名后端攻城🦁"
                            }).then(function () {
                                botui.message.add({
                                    delay: 1800,
                                    content: "当然闲暇时间喜欢摸摸🐟，和小鹏鹏打打🎮"
                                }).then(function () {
                                    botui.action.button({
                                        delay: 1100,
                                        action: [{
        ...
        fourthpart = function () {
            botui.message.add({
                ...
                botui.message.add({
                    delay: 1100,
                    content: "hhh,说笑了，其实是为了记录自己的成长历程，我想这是一件很有意义的事情 "
                }).then(function () {
                    botui.action.button({
                        delay: 1500,
                        action: [{
        ...
        fifthpart = function () {
            botui.message.add({
                delay: 1e3,
                content: "emmm,牛客刷满1000道题，英语单词坚持背满1年等，我相信我可以做到！"
            }).then(function () {
                botui.message.add({
                    delay: 1600,
