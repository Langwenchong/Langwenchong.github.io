...
categories: 
	- [知识分享,学习心得]
headimg: https://langwenchong.gitee.io/figure-bed/20210704135336.png
---
...
![](https://langwenchong.gitee.io/figure-bed/20210124130828.png)
...
我们按照廖雪峰老师的教学步骤来进行，你可以参考我的过程截图来确认自己是否正在正确进行。我们先创建gitlearn然后输入git init初始化这个仓库，至此这个本地的库就建好了，实际上就是多了一个.git文件并且一般是隐藏的。我们在做[nemu](https://coolchong.cn/tags/nemu/)时也知道.git文件中有一个叫做git log的功能可以实现记录我们的每一次改动从而做到版本回溯实际上就是在.git中实现的。现在我们检验一下.git文件是否存在。

![](https://langwenchong.gitee.io/figure-bed/20210124132504.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124133853.png)

![](https://langwenchong.gitee.io/figure-bed/20210124133915.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124135257.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124142543.png)

他会和上一次的提交进行对比并告诉我们两者之间的区别，这样我们就可以了解当前的仓库状态了。上面说到readme.txt被修改了但是还没有保存提交，所以此时我们使用git log查看时并没有记录这次修改。

![](https://langwenchong.gitee.io/figure-bed/20210124142758.png)

但是我们发现此时只是知道了某个文件被修改了，却不知道具体的修改之处，此时我们可以输入git diff查看文件具体哪里出现了修改。

![](https://langwenchong.gitee.io/figure-bed/20210124142916.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124143340.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124143641.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124144357.png)

此时readme.txt内容如下：

![](https://langwenchong.gitee.io/figure-bed/20210124144428.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124144811.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124145540.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124145736.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124150351.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124150706.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124152436.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124152722.png)

当然此时git也会把这次提交看成一个版本库，所以在git log中也会记录这次修改：

![](https://langwenchong.gitee.io/figure-bed/20210124152809.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210124153040.png)

当然我们此时的git log中就没有版本4删除文件的提交信息了，就好像版本4不存在过一样：

![](https://langwenchong.gitee.io/figure-bed/20210124153201.png)
