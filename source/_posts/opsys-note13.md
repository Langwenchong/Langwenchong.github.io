...
![](https://langwenchong.gitee.io/figure-bed/20201228171319.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201228171426.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201228154113.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201228154458.png)

#### 地址变换过程（引入快表）

一般访问快表TLB只需要1微秒，而访问内存需要100微秒。现在我们同样以图示演示一下用快表寻找（0,0）（0,4）（0,8）这几个逻辑地址。

![](https://langwenchong.gitee.io/figure-bed/20201228154643.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201228160359.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201228161048.png)

这里我们在学习了机组原理后知道有一个和TLB非常类似的机构叫做Cache实际上两者是由区别的：TLB中只有页表项的副本，而普通Cache中可能会有其他各种数据的副本。但是解决问题的思路是类似的，实战请参考：[缓存Cache实验](https://coolchong.cn/2020/10/23/comsyshomework5/)

### 两级页表

#### 单级页表存在的问题

![](https://langwenchong.gitee.io/figure-bed/20201228171530.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201228171626.png)

现在我们将这1024个部分也离散存放然后建立一张表格来记录各部分所存储的位置。如下：

![](https://langwenchong.gitee.io/figure-bed/20201228163435.png)

此时一级页号（页目录号）有1024项记录的是1024个部分所存储的页框号，然后二级页号对应的是某个页表中的页号（即页号），最后12位还是页内偏移量。例如此时

![](https://langwenchong.gitee.io/figure-bed/20201228163657.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201228164747.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201228170258.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201228171151.png)
