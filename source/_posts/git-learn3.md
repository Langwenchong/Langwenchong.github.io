...
categories: 
	- [知识分享,学习心得]
headimg: https://langwenchong.gitee.io/figure-bed/20210704135502.png
---
...
![](https://langwenchong.gitee.io/figure-bed/20210126122908.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126125337.png)

也就是说HEAD指针永远指向分支的最新节点，而现在我们可以创建一个新的分支并且将HEAD切换到新分支dev上，如下图：

![](https://langwenchong.gitee.io/figure-bed/20210126125838.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126125958.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126130652.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126132649.png)

那么此时我们就来到了下图的情况：

![](https://langwenchong.gitee.io/figure-bed/20210126132806.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126133033.png)

然后我们切回到master分支，那么在查看此时HEAD指向的master最新版本3的readme.txt发现确实没有新加的那句话：

![](https://langwenchong.gitee.io/figure-bed/20210126133311.png)

那么现在我们尝试合并两个分支，即将dev的版本4加到master上，即变成下图的情况：

![](https://langwenchong.gitee.io/figure-bed/20210126133556.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126133807.png)

![](https://langwenchong.gitee.io/figure-bed/20210126134007.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126134054.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126134859.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126152117.png)

那么此时如果feature往后更新了一个版本为ab，同时master也自己更新了一个版本bc如下图：

<img src="https://langwenchong.gitee.io/figure-bed/20210126152645.png" style="zoom: 80%;" />
...
<img src="https://langwenchong.gitee.io/figure-bed/20210126153057.png"  />
...
![](https://langwenchong.gitee.io/figure-bed/20210126163042.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126155109.png)

此时master确实是两个版本，a->ca，然后我们看一下feature分支：

![](https://langwenchong.gitee.io/figure-bed/20210126155147.png)

此时feature确实是两个版本，a->ab,然后我们尝试将feature合并到master：

![](https://langwenchong.gitee.io/figure-bed/20210126155307.png)

此时我们发现出现冲突了，我们查看一下readme.txt文件信息：

![](https://langwenchong.gitee.io/figure-bed/20210126161626.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126154147.png)

这就是解决冲突的办法。此时在输入以图的形式查看

![](https://langwenchong.gitee.io/figure-bed/20210126165104.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210126170406.png)

那么此时如果要将feature合并到master分支，那么合并后的情况会如下图所示：

![](https://langwenchong.gitee.io/figure-bed/20210126170509.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210127155416.png)
...
![](https://langwenchong.gitee.io/figure-bed/20210127160447.png)
