...
![](https://langwenchong.gitee.io/figure-bed/20201227164909.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227144508.png)

首先高级指令x=x+1翻译成处理机可以看懂的二进制指令串（可能一个高级指令会对应多条二进制指令），然后cpu执行这个二进制指令串。

![](https://langwenchong.gitee.io/figure-bed/20201227144631.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227145319.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227145703.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227150602.png)

那么此时在对文件进行编译，链接后指令中不在使用逻辑地址，而是直接转换为物理地址如上图，此时在将装入模块（可执行文件）放入内存中，当处理机执行到指令0和指令1时就会到正确的存储单元（物理地址为179）读/写数据。如下图：

![](https://langwenchong.gitee.io/figure-bed/20201227150745.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227151703.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227152945.png)

执行时：

![](https://langwenchong.gitee.io/figure-bed/20201227153018.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227154023.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227154437.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227154636.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227154919.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227155151.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227155520.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227165015.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227160126.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227160344.png)

![](https://langwenchong.gitee.io/figure-bed/20201227160352.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227160605.png)

![](https://langwenchong.gitee.io/figure-bed/20201227160616.png)

所以管理判断是否越界的是界地址寄存器，并且策略2是根据逻辑地址进行越界检查的，而策略1是根据物理地址进行越界检查的。

#### 总结

![](https://langwenchong.gitee.io/figure-bed/20201227160723.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227162408.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227162603.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227163039.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227165106.png)

##### 思考：交换技术应该将挂起的进程放在外存（磁盘）的什么位置？

具有对换功能的操作系统中，通常把磁盘空间分为文件区和对换区两部分。文件区主要用于存放文件，主要追求存储空间的利用率，因此对文件区空间的管理采用离散分配方式（空间碎片少）。

![](https://langwenchong.gitee.io/figure-bed/20201227163607.png)
...
![](https://langwenchong.gitee.io/figure-bed/20201227164239.png)
